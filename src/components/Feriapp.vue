<template>
  <b-row >
    <b-col cols='12' class='text-center'>
      ...
      <small class='legend text-light'>Feriapp login page</small>
    </b-col>
    <b-col cols='12'>
    ...
    <b-col cols='12'>
      ...
      <b-col cols='12' class='text-center'>
        ...
        <small class='legend text-light'>Easy access to main functionalities</small>
      </b-col>
    ...
    <b-col cols='12' lg='6'>
      ...
      <br/>
      <small class='legend text-light'>Form to create day-offs</small>
    </b-col>
    <b-col cols='12' lg='6'>
      <img class='img-fluid mx-auto d-flex' src='https://storage.googleapis.com/ennes/feriapp/pdf_abono.png' alt='Abono generated pdf' /> 
      <br />
      <small class='legend text-light'>Generated pdf</small>
    </b-col>
    <b-col cols='12' class='text'>
      <strong class='subtitle'>PDF generation</strong>
      <p class='mt-3'>
      ...
      <strong class='subtitle'>Banners</strong>
      <p class='mt-3'>
    ...
    <b-col cols='12'>
      ...
      <br/>
      <small class='legend text-light'>Relatórios</small>
    </b-col>

    <b-col cols='12' class='text'>
      <strong class='subtitle'>Relatórios</strong>
      <p class='mt-3'>
    ...
    <b-col cols='12'>
      ...
      <br/>
      <small class='legend text-light'>Vacation monitoring</small>
    </b-col>

    <b-col cols='12' class='text'>
      <strong class='subtitle'>Monitoring</strong>
      <p class='mt-3'>
